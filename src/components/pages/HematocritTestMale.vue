<template>
    ...
    <hematocrit-results-male v-if="printIsTrue">
    ...
    <form>
        ...
        <div class="form-control">
            ...
            <div class="txtNorm">
                ...
                <div>
                    <label  class="lDwn" >14 - 18 g/dL</label>
                </div>
...
import HematocritResultsMale from '../UI/HematocritResultsMale.vue'
export default {
    data() {
        return{
            pharmName:'',
  ...
  components: { BaseCard, HematocritResultsMale },
