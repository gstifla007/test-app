    ...
    <form>
        ...
        <!-- TYPE COLUMN -->
            ...
            <div class="radio-toolbar">
                ...
                <div class="check">
                    <input type="radio" id="crad" name="radio" value="C Present" v-model="typInpt" @blur="validateTyp" @click="validateTyp" >
                    <label for="crad">Only C</label>
                    
                </div>
                
                <div class="check">
                    <input type="radio" id="cgrad" name="radio" value="C and G Present" v-model="typInpt" @blur="validateTyp" @click="validateTyp">
                    <label for="cgrad">C &amp; G</label>
                </div>
                
                <div class="check">
                    <input type="radio" id="cmrad" name="radio" value="C and M Present" v-model="typInpt" @blur="validateTyp" @click="validateTyp">
                    <label for="cmrad">C &amp; M</label>
                </div>
                
                <div class="check">
                    <input type="radio" id="cgmrad" name="radio" value="C, G and M Present" v-model="typInpt" @blur="validateTyp" @click="validateTyp">
