...
<head>
  ...
  <dialog open id="printModal">
    ...
    <section class="custPrint">
      ...
      <slot name="sAge"></slot> &lpar; M &rpar;  &nbsp;&nbsp;|&nbsp;&nbsp; <slot name="sPhone"></slot></p>
    </section>

    <section>
      <table class="table">
            <tr>
                <td class="td1">CHOL</td>
                <td class="td2"><slot name="sTotal"></slot></td>
                <td class="td3"><slot name="totalVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">HDL</td>
                <td class="td2"><slot name="sHdl"></slot></td>
                <td class="td3"><slot name="hdlVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">LDL</td>
                <td class="td2"><slot name="sLdl"></slot></td>
                <td class="td3"><slot name="ldlVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">TRIG</td>
                <td class="td2"><slot name="sTrig"></slot></td>
                <td class="td3"><slot name="trigVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">CHOL/HDL</td>
                <td class="td2"><slot name="sRatio"></slot></td>
                <td class="td3"><slot name="ratioVal"></slot></td>
            </tr>
