  ...
  <dialog open id="printModal">
    ...
    <section>
      <table class="table">
            <tr>
                <td class="td1">SYS</td>
                <td class="td2"><slot name="sSYS"></slot></td>
                <td class="td3"><slot name="sSysVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">DIA</td>
                <td class="td2"><slot name="diaInput"></slot></td>
                <td class="td3"><slot name="sDiaVal"></slot></td>
            </tr>
            <tr>
                <td class="td1">PULSE</td>
                <td class="td2"><slot name="sPulse"></slot></td>
                <td class="td3"><slot name="sPulseVal"></slot></td>
            </tr>
...
export default {
  ...
  emits: ['closePrint'],
  computed:{
    // colorCode(low, medium, normal, high){
  },
  methods: {
