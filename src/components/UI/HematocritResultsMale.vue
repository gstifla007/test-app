  ...
  <dialog open id="printModal">
    ...
    <section>
      <table class="table">
            <tr>
                <td class="td1">HB</td>
                <td class="td2"><slot name="sHb"></slot></td>
                <td class="td3"><slot name="sHbResult"></slot></td>
            </tr>
            <tr>
                <td class="td1">HCT</td>
                <td class="td2"><slot name="sHct"></slot></td>
                <td class="td3"><slot name="sHctResult"></slot></td>
            </tr>
